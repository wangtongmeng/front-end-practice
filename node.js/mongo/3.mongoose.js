...
// (async () => {
//     let user = await UserModel.create({ username: 'wtm', password: 'wtm' });
...
(async ()=>{
//   let r = await ArticleModel.findById('608fbe8d76553125c8029dab').populate('user_id',{_id:0});
//   console.log(r);
    let r = await ArticleModel.aggregate([
        ...
        {
            $match:{
                _id:mongoose.Types.ObjectId('608fbe8d76553125c8029dab')
            }
        },
        {
