...
// global中的属性 console.log(global) console.dir(global, {showHidden:true })
//  clearInterval clearTimeout
//  queueMicrotask
//  clearImmediate setImmediate 自己实现 (ie下也有这两个方法)

// 掌握一些node新增的 能通过global直接访问的属性 全局属性 https://nodejs.org/dist/latest-v14.x/docs/api/globals.html

// Buffer node中的二进制对象 (最早的时候浏览器不能直接读写文件)
// __dirname __filename process setImmediate
...
// 2.
// process.chdir('../')
// console.log(process.cwd()) // c:\Users\admin\Desktop\front-end-practice\node.js => c:\Users\admin\Desktop\front-end-practice
// 3.
// console.log(process.cwd()) // 在哪运行目录就只想哪里(例如命令行在特定目录下执行命令或包含命令的文件，cwd()指向当前目录)
//   ~/Desktop/front-end-practice/node.js 目录下 node 3.node-core/1.js => C:\Users\admin\Desktop\front-end-practice\node.js
//   ~/Desktop/front-end-practice/node.js/3.node-core 目录 node 1.js =>C:\Users\admin\Desktop\front-end-practice\node.js\3.node-core
// 4. 计算机->属性->高级系统设置
// console.log(process.env)
// .env文件 设置环境变量 set A=1(win)  export A=1(mac) node 1.js 可以在process.env中看到A
// set NODE_ENV=development node 1.js
...
// console.log(process.argv); // 会根据用户传递的参数来解析 生成对应的功能  node 1.js --port 3000 --info abc
